...
public class ShopObjects {
    public static By linkTextWomen =  By.linkText("WOME");
    public static By availabilityStatus = By.cssSelector(".right-block>.availability>.available-now");
    public static By viewMoreButton = By.cssSelector(".product-container>.right-block>.button-container>a.nth-of-type(2)");
 //   public static By viewMoreButton = By.xpath("(//a[@itemprop='url'][contains(.,'More')])[1]");
